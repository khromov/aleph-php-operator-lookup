...
export default function Page() {
    ...
    const generatedItems = operators.map((feature, index) => {
        ...
        if(index === selectedItem) {
            return (
                <div className="p-2 cursor-pointer" key={index} onClick={() => setSelectedItem(index)}>
            ...
            <div className="flex flex-col h-screen items-center justify-center mt-30">
                ...
                <div className="text-white font-bold rounded-lg border p-2">
                    <div className="relative text-gray-600">
                        <input onChange={(event) => searchResolver(event.target.value)} type="search" name="search" placeholder="Search" className="bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none" />
                ...
                <div className="block m-2 mb-4 text-center h-10">
